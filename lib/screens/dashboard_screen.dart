      ...
      builder: (_) {
        ...
        return AlertDialog(
          ...
          content: DropdownButtonFormField<String>(
            items: [ // Použití přeložených klíčů
              DropdownMenuItem(value: 'summary', child: Text(localizations.translate('summary'))),
              DropdownMenuItem(value: 'top_products', child: Text(localizations.translate('topProducts'))),
              DropdownMenuItem(value: 'top_categories', child: Text(localizations.translate('topCategories'))),
              DropdownMenuItem(value: 'hourly_graph', child: Text(localizations.translate('hourlyGraph'))),
              DropdownMenuItem(value: 'payment_pie_chart', child: Text(localizations.translate('paymentPieChart'))),
              DropdownMenuItem(value: 'today_revenue', child: Text(localizations.translate('todayRevenue'))),
            ],
